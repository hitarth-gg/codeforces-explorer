import {
  ...
  export default function TableCorrect() {
    const authContext = useAuth();
    const [tempq, setTempq] = useState(authContext.correctSubmissions);
    ...
    useEffect(() => {
      setTempq(authContext.correctSubmissions);
      setPageNo(0);
    }, [authContext.correctSubmissions]);
